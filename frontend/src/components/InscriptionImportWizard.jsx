...
import { applyPreparationFilterChange, canFinalizeDraft, clearPreparationSelection, filterPreparationRecords, selectedOctoberIds } from "./importPreparationView";
...
const COPY = {
  es: {
    ...
    filter: "Buscar jugador", allCategories: "Todas las categorías", allTeams: "Todos los equipos", selected: "seleccionados", clearSelection: "Deseleccionar todos", age: "Edad", previousTeam: "Equipo anterior", allStates: "Todos los estados", withIncidents: "Con incidencias", ready: "Sin incidencias",
  ...
  eu: {
    ...
    filter: "Jokalaria bilatu", allCategories: "Kategoria guztiak", allTeams: "Talde guztiak", selected: "hautatuta", clearSelection: "Hautaketa guztia kendu", age: "Adina", previousTeam: "Aurreko taldea", allStates: "Egoera guztiak", withIncidents: "Gorabeherekin", ready: "Gorabeherarik gabe",
