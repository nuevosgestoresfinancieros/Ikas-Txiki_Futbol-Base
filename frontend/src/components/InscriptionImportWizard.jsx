...
const COPY = {
  es: {
    ...
    historicalMode: "Base histórica: simulación aislada", historicalHelp: "Las categorías y equipos importados son valores provisionales: deben confirmarse desde los catálogos existentes. Los 54 casos sin equipo permanecen en revisión y la importación definitiva está bloqueada.",
  ...
  eu: {
    ...
    historicalMode: "Datu-base historikoa: simulazio isolatua", historicalHelp: "Inportatutako kategoriak eta taldeak behin-behineko balioak dira: dauden katalogoetatik baieztatu behar dira. Talderik gabeko 54 kasuak berrikusteko geratzen dira eta behin betiko inportazioa blokeatuta dago.",
