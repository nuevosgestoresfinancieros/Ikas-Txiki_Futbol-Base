...
export default function Portal({ user }) {
  ...
  const download = async (path, filename, params) => {
    try {
      const response = await api.get(path, { ...(params ? { params } : {}), responseType: "blob" });
