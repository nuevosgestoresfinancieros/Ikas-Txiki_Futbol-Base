...
const emptyForm = {
  ...
  assigned_team_ids: [], assigned_category_ids: [], player_id: "", family_id: "", family_contact_slot: null, language: "es",
...
export default function Users() {
  ...
  const selectedFamily = useMemo(() => families.find((family) => family.id === form.family_id), [families, form.family_id]);
