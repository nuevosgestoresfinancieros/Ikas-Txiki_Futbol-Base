...
- La familia puede descargar el PDF bilingüe, subir PDF/JPG/PNG/WEBP o dibujar una firma electrónica sencilla con nombre, consentimiento, modalidad, fecha, usuario, tamaño, MIME y hash. La evidencia queda fuera de MongoDB; MongoDB conserva únicamente metadatos y una ruta generada por el servidor.
