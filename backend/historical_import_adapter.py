...
def _parse_compact_sheets(formula_sheet, value_sheet, id_factory) -> dict:
    ...
    for source_row, (formula_row, value_row) in enumerate(zip(formula_rows, value_rows), 2):
        ...
        record = {
            ...
            # El club ha confirmado que EQUIPO 25&26 es la referencia
            # operativa de todos los jugadores de esta carga.
            "equipo": _norm(value_row[41]), "categoria": _norm(value_row[43]),
            ...
            "historical": {
                ...
                "sport": {"program_2025_2026": _norm(value_row[37]),
                          ...
                          "team_assignment_source": "2025-2026"},
