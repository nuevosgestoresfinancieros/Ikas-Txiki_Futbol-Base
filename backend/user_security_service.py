...
def security_public(user: Mapping[str, Any]) -> dict:
    ...
    return {
        ...
        "invitation_delivery_status": (user.get("invitation_delivery") or {}).get("status"),
        "invitation_delivery_error": (user.get("invitation_delivery") or {}).get("error"),
        "invitation_delivery_error_detail": (user.get("invitation_delivery") or {}).get("error_detail"),
        "invitation_delivery_created_at": (user.get("invitation_delivery") or {}).get("created_at"),
        "invitation_delivery_sent_at": (user.get("invitation_delivery") or {}).get("sent_at"),
        "invitation_delivery_message_id": (user.get("invitation_delivery") or {}).get("message_id"),
